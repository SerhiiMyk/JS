...
// document.write(`<div class="template_2_1">`);
//     for (const simpson of simpsons){
//         document.write(`<div> ${simpson.name} - ${simpson. surname} - ${simpson.age} <img src="${simpson.photo}" alt=""/></div>`);
//     }
// document.write(`</div>`);

// document.write(`<div class="template_2_2">`);
//     for (const simpson of simpsons){
//         document.write(`
//             <div>
//                 <h2>${simpson.name} ${simpson. surname}. Age is - ${simpson.age} years</h2>
//                 <p>${simpson.info}</p>
